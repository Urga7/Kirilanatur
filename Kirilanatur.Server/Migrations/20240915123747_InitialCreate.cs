    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariationTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VariationTranslations_Variations_VariationId",
                        column: x => x.VariationId,
                        principalTable: "Variations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImageTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductImageTranslations_ProductImages_ProductImageId",
            ...
            migrationBuilder.CreateTable(
                name: "VariationOptionTranslations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariationOptionTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VariationOptionTranslations_VariationOptions_VariationOptionId",
                        column: x => x.VariationOptionId,
                        principalTable: "VariationOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductImageTranslations_ProductImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariationOptionTranslations_VariationOptionId",
                table: "VariationOptionTranslations",
                column: "VariationOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariationTranslations_VariationId",
                table: "VariationTranslations",
                column: "VariationId");
        }
